...
-- it would be nice if I figured out how to use environment variables to do the
-- theme setting with a relative path like this instead of hard coding it
-- beautiful.init(awful.util.get_themes_dir() .. "pony/theme.lua")
...
awful.rules.rules = {
    ...
    -- Add titlebars to dialogs but not normal clients
