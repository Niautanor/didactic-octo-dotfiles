...
beautiful.init("~/.config/awesome/themes/pony/theme.lua")
...
awful.rules.rules = {
    ...
    { rule = { class = "gimp" },
      properties = { floating = true } },
      -- I am not sure if the rule below works
    { rule = { class = "gimp", type = "utility" },
      properties = { ontop = true } },
      -- windows things should be floating
    { rule = { class = "Wine" },
      properties = { floating = true } }
}
-- }}}
...
client.connect_signal("manage", function (c, startup)
    ...
    -- for some reason okular always spawns with only one of the maximized properties set which is a massive pain in the ass if you look at the definition of the mod+m keybinding
    if not startup then
...
-- TODO try to enable titlebars only for the focused window and see if that looks good
